  ...
  <div class="row justify-content-center">
    <div class="col-md-8">
      <div class="card">
        ...
        <div class="card-body">
          <p>
            Você {{ Auth::user()->student->category }}, {{ Auth::user()->name }}
            está inscrito nos seguintes cursos:
          </p>
          @forelse (Auth::user()->student->purchases->sortDesc() as $purchase)
            ...
            @if ($purchase->paid_out)
              <p class="text-success">Este curso ja foi pago.</p>
              <a
            ...
            @else
              <p class="text-danger">
                Realize o pagamento para ter acesso ao material do curso
              </p>
              <a
              ...
              <form
                action="{{ route('student.purchases.destroy', $purchase->id) }}"
                method="post"
                class="d-inline"
              >
                @csrf 
